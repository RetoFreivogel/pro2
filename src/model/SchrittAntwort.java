...
/**
 * Die Schrittantwort einer Übertragungsfunktion
 * 
...
public class SchrittAntwort {
	...
	/**
	 * Erzeugt eine neue Schrittantwort mit den gegebenen Residuen und Wurzeln
	 * Die Anzahl und Reihenfolge der Residuen und Wurzeln muss gleich sein
	 * 
	 * @param poles
	 *            Die Polstellen der Übertragungsfunktion
	 * @param residues
	 *            Die Residuen der Übertragungsfunktion
	 */
	...
	/**
	 * Gibt an ob die Schrittantwort ausschwingt
	 * 
	 * @return boolean
	 */
	...
	/**
	 * Gibt an ob die Schrittantwort asymptotisch zum Endwert geht.
	 * 
	 * @return boolean
	 */
	...
	/**
	 * Gibt die Zeit zurück bis die Schwingungen kleiner als 0.001 sind.
	 * 
	 * @return Die Ausschwingzeit
	 */
	...
	/**
	 * Gibt den Zeitpunkt zurück bei dem das Maximum erreicht wird
	 * 
	 * @return Der Zeitpunkt des Maximums
	 */
	...
	/**
	 * Gibt die Zeit zurück, welche die Schrittantwort braucht um den Endwert
	 * zum ersten mal zu übersteigen.
	 * 
	 * @return Die Anschwingzeit
	 */
	...
	/**
	 * Gibt den maximalen Wert der kurve zurück
	 * 
	...
	/**
	 * Gibt den y Wert an der Stelle x zurück
	 * 
	 * @param x
	 *            Die gefragte Stelle
	 * @return Der Wert an dieser Stelle
	 */
	...
	private double calcTaus(double delta) {
		if (delta > 1 || delta <= 0) {
			throw new IllegalArgumentException(
					"delta muss zwischen 0 und 1 sein");
		}
