...
public class RegelStrecke extends Observable implements RegelGlied {
	...
	static final double spline(double v) {

		final double[] x = { 0.00000000000000e+000, 16.0950576774209e-003,
		...
		final double[] y = { 0.00000000000000e+000, 20.4081632653061e-003,
