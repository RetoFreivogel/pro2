...
\todo{gesamtes Kapitel schreiben}
\todo{in der Software nicht erreichte Möglichkeiten herauslöschen!!}
Falls die berechnete und dargestellte Schrittantwort der Regelung nicht der Vorstellung und den Ansprüchen des Nutzeres entspricht, soll dieser die Möglichkeiten haben, die Schrittantwort nach seinen Anforderungen zu optimieren. Dazu gibt es verschieden Möglichkeiten. 
...
Es besteht jedoch die Möglichkeit die Optimierungen durch verändern gewisser Parameter in der Phasengangmethode durchzuführen. So ist es aus der Theorie ersichtlich [Kapitel Grundlagen Phasengangmethode], dass das der gewählte Phasenrand auf das Überschwingen Einfluss hat. Aus der berechneten Schrittantwort kann das maximale Überschwingen einfach herausgefunden werden.\todo{Verweis auf Grundlagen Phasengangmethode Tabelle 3}\\
Die Berechnung wird so angepasst, dass der Benutzer ein Überschwingen in Prozent auswählen kann. Dann wird der Phasenrand solange verändert, bis das Überschwingen der Schrittantwort mit dem gewählten Überschwingen übereinstimmt.\\

\todo{falls nicht implementiert, löschen}
Zusätzlich hat der Punkt der im Phasengang der Strecke gesucht wird und zur Knickkreisfrequenz führt, Einfluss auf die Anstiegsgeschwindigkeit der Schrittantwort.[gemäss Kapitel Grundlagen Phasengangmethode]. \todo{Verweis auf Grundlagen Phasengangmethode Tabelle 2}\\
