...
%Datum anpassen***************************************************************
\ohead{Protokoll vom 07.05.2015} 
...
%Titel
%Datum anpassen**************************************************************
\section*{\textbf{Protokoll zur Sitzung am 07.05.2015}}
...
Datum, Zeit, Ort & \multicolumn{2}{|l|}{07.05.2015, 09:10-09:30 Uhr, FHNW Windisch, Gebäude 1, 1.021}\\ \hline
...
Claudius und Denis haben die Legende nicht programmiert. Nur Checkboxen konnten erstellt werden.

\subsubsection*{\tiny{BESCHLUSS}}

Reto übernimmt das Problem: Legende.

\noindent\rule{\textwidth}{0.4pt}
\subsection*{\textbf{Weiteres Vorgehen / Ausblick}}
\subsubsection*{\tiny{DISKUSSION}}

Das Abstract muss noch erstellt werden.
\newline
Diverse Problematiken mit Latex, u.a. das zitieren.

\subsubsection*{\tiny{BESCHLUSS}}

\begin{description}
\item[Alex] Schreibt weiter an Einleitung. 
\item[Claudius] Schreibt das Abstract und befasst sich mit den Problemen von Latex. Übersetzt die Protokolle in Latex.
\item[Denis] Beginnt mit dem programmtechnischen Bericht.
\item[Martin] Schreibt weiter am mathematischen Bericht.
\item[Reto] Programmiert weiter an Zellweger und Phasengangmethode und nimmt sich der Legende an.
\item[Yohannes] Testet die Faustformeln des Programms.
\end{description}
