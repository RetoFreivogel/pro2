...
%Datum anpassen***************************************************************
\ohead{Protokoll vom 05.05.2015} 
...
%Titel
%Datum anpassen**************************************************************
\section*{\textbf{Protokoll zur Sitzung am 05.05.2015}}
...
Datum, Zeit, Ort & \multicolumn{2}{|l|}{05.05.2015, 08:15-09:10 Uhr, FHNW Windisch, Gebäude 1, 1.021}\\ \hline
...
MenuBar ist noch nicht fertig.
\newline
Faustformeln angepasst.

\subsubsection*{\tiny{BESCHLUSS}}

Alex macht weiter an MenuBar.

\noindent\rule{\textwidth}{0.4pt}
\subsection*{\textbf{Weiteres Vorgehen / Ausblick}}
\subsubsection*{\tiny{DISKUSSION}}

Denis soll programmieren von Zellweger übernehmen.
\newline
Weitere Programmierarbeiten werden vergeben.

\subsubsection*{\tiny{BESCHLUSS}}

\begin{description}
\item[Alex] MenuBar programmieren, Einleitung schreiben
\item[Claudius] befasst sich mit der Legende: max fünf Kurven, in verschiedenen Farben.
\item[Denis] programmiert an Zellweger.
\item[Martin] Schreibt weiter am mathematischen Bericht. Bringt main.tex zum laufen.
\item[Reto] Befasst sich mit programmieren von undoredo
\item[Yohannes] Setzt die Tests von den Faustformeln fort.
\end{description}
