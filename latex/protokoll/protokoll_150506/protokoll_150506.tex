...
%Datum anpassen***************************************************************
\ohead{Protokoll vom 06.05.2015} 
...
%Titel
%Datum anpassen**************************************************************
\section*{\textbf{Protokoll zur Sitzung am 06.05.2015}}
...
Datum, Zeit, Ort & \multicolumn{2}{|l|}{06.05.2015, 08:30-08:40 Uhr, FHNW Windisch, Gebäude 1, 1.021}\\ \hline
...
Reto präsentiert Stand der Software: undoredo weiter in Arbeit, Zellweger und Phasengangmethode noch nicht fertig, Legende nicht fertig, Regler wird durch Befehl NEU nicht zurückgesetzt.
\newline
MAIN.TEX läuft, Umlaute werden angezeigt. Lösung mit UTF8.

\subsubsection*{\tiny{BESCHLUSS}}

Arbeiten unter Traktand: Weiteres Vorgehen / Ausblick verteilt.

\noindent\rule{\textwidth}{0.4pt}
\subsection*{\textbf{Weiteres Vorgehen / Ausblick}}
\subsubsection*{\tiny{DISKUSSION}}

Alex verteilt arbeiten.

\subsubsection*{\tiny{BESCHLUSS}}
Um 13:30 Uhr ist im Zimmer 3.041 ein Fachinput von Niklaus.
\newline
\begin{description}
\item[Alex] Schreibt Einleitung für Ende Woche. Erstellt ein erstes Fishbone-Diagramm für den PMA-Bericht.
\item[Claudius] Programmiert weiter an Legende
\item[Denis] Hilft Claudius.
\item[Martin] Schreibt weiter am mathematischen Bericht
\item[Reto] Befasst sich mit Phasengangmethode und Zellweger.
\item[Yohannes] Setzt die Tests von Faustformeln fort.
\end{description}
